...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_614aa32c4e4d6c56, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_614aa32c4e4d6c56, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "playchain.playchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "playchain.playchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("playchain/playchain/tx.proto", fileDescriptor_614aa32c4e4d6c56) }

var fileDescriptor_614aa32c4e4d6c56 = []byte{
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x8b, 0x81, 0x5b, 0x35, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/playchain.playchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/playchain.playchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "playchain.playchain.Msg",
	...
	Metadata: "playchain/playchain/tx.proto",
}
